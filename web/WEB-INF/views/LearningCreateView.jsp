<%-- 
    Document   : LearningCreateView.jsp
...
<html lang="pt-BR">
    ...
    <body>
        ...
        <div id="main" class="container-fluid">
            ...
            <!-- FORM MAIN -->
            <form id="formCreate" name="formCreate" method="POST" action="${urlToGo}">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <SELECT id="groupInput" name="groupInput" required="required" placeholder="Selecione um grupo" size="1" class="form-control" >
                            <c:forEach var="o" items="${groups}">
                                <option value="${o.id}">${o.termObjectGroupName}</option>
                            </c:forEach>                                    
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <SELECT id="objectInput" name="objectInput" required="required" placeholder="Selecione o classificador" size="1" class="form-control" >
                            <c:forEach var="o" items="${objects}">
                                <option value="${o.id}">${o.termObjectName}</option>
                            </c:forEach>                                    
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control" id="term1Input" name="term1Input" required="required" placeholder="Digite um termo p/ procura" maxlength="50">                       
                        &nbsp;<span id="term1InputCount" class="badge badge-warning">50 Restantes!</span>
                    </div>

                    <div class="form-group col-md-3">
                        <label for="term1Input">Termo 2:</label>
                        <input type="text" class="form-control" id="term2Input" name="term2Input" placeholder="Digite um segundo termo p/ procura" maxlength="50">                       
                        &nbsp;<span id="term2InputCount" class="badge badge-warning">50 Restantes!</span>
                    </div>                    
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control" id="initLikeInput" name="initLikeInput" size="10" maxlength="10" value="%">  
                        &nbsp;<span id="initLikeInputCount" class="badge badge-warning">5 Restantes!</span>
                    </div>

                    <div class="form-group col-md-3">
                        <label for="finishLikeInput">Like final</label>                           
                        <input type="text" class="form-control" id="finishLikeInput" name="finishLikeInput" size="10" maxlength="10" value="%">  
                        &nbsp;<span id="finishLikeInputCount" class="badge badge-warning">5 Restantes!</span>
                    </div>                                                           
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control" id="subTypeInput" name="subTypeInput" placeholder="Digite um agrupador" maxlength="50">                       
                        &nbsp;<span id="subTypeInputCount" class="badge badge-warning">50 Restantes!</span>
                    </div>                            
