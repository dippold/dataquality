 ...
 *
 */
public class TermObjectCmd extends MVC implements ICmd {
    ...
    public String buildGridModel(HttpServletRequest request, HttpServletResponse response) {
        ...
        final String[] headers = {"ID", "Objeto", "Grupo", "Ações"};

        request.setAttribute("headers", headers);
        request.setAttribute("title", "Objetos de Aprendizados");
        request.setAttribute("datasource", findAllObjects());

        return "WEB-INF/views/TermObjectListView.jsp";
    }
